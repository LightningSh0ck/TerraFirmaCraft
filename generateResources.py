...
for key in METAL_TYPES:
    blockstate(('sheet', key), 'tfc:empty', textures={
        ...
        'north': {
            'true': {
                'submodel': {'north': {'model': 'tfc:sheet', 'x': 90}}
            },
            'false': {}
        },
        'south': {
            'true': {
                'submodel': {'south': {'model': 'tfc:sheet', 'y': 180, 'x': 90}}
            },
            'false': {}
        },
        'east': {
            'true': {
                'submodel': {'east': {'model': 'tfc:sheet', 'y': 90, 'x': 90}}
            },
            'false': {}
        },
        'west': {
            'true': {
                'submodel': {'west': {'model': 'tfc:sheet', 'y': 270, 'x': 90}}
            },
            'false': {}
        },
        'up': {
            'true': {
                'submodel': {'up': {'model': 'tfc:sheet'}}
            },
            'false': {}
        },
        'down': {
            'true': {
                'submodel': {'down': {'model': 'tfc:sheet', 'x': 180}}
            },
            'false': {}
        }
        # 'face': {
