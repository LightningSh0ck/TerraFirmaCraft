...
public class BlockMetalSheet extends Block
{
    ...
    private static final PropertyBool[] FACE_PROPERTIES = new PropertyBool[] {
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        if (tile != null)
        {
            Item item = ItemMetalSheet.get(metal, Metal.ItemType.SHEET);
            drops.add(new ItemStack(item, tile.getFaceCount()));
        }
    }
    ...
    {
        return new ItemStack(ItemMetalSheet.get(metal, Metal.ItemType.SHEET));
    }
}
